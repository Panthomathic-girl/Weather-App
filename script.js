...
const handlingError = document.querySelector(".handlingError");
...
function switchTab(newTab) {
    if(newTab != oldTab) {
        ...
        handlingError.classList.remove("active");
...
async function fetchSearchWeatherInfo(city) {
    ...
    userInfoContainer.classList.remove("active");
    grantAccessContainer.classList.remove("active");
    handlingError.classList.remove("active"); // Reset error state
    ...
    try {
        ...
        handlingError.classList.add("active"); // Display error message or image
    }
}
